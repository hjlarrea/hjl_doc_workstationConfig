# Windows Terminal configuration guide & WSL Ubuntu Configuration

The idea of this document is to collect all the configuration steps I use in the Windows terminal and in in WSL (Ubuntu 20.04).
